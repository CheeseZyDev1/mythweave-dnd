...
export function DiceTable({ initialTable, initialRolls, members, currentUserId, invalidTable }: { initialTable: TableInfo | null; initialRolls: DiceRoll[]; members: Member[]; currentUserId: string; invalidTable: boolean }) {
