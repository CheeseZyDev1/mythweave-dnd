...
export function InitiativePanel({ tableId, initialEntries, initialTracker, readOnly=false }: { tableId: string; initialEntries: InitiativeEntry[]; initialTracker: InitiativeTracker | null; readOnly?:boolean }) {
