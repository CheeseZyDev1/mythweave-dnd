...
try {
  ...
  async function fastTravel(locationId){const response=await fetch(`${appUrl}/api/world/travel`,{method:"POST",headers:{"Content-Type":"application/json",Cookie:cookie},body:JSON.stringify({characterId,locationId})});return{response,body:await response.json()};}
